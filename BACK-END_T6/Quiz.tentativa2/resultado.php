...
<body>
    ...
    if(isset($_POST['nome']) && isset($_POST['resposta1']) && isset($_POST['resposta2']) && isset($_POST['resposta3']) && isset($_POST['resposta4']) && isset($_POST['resposta5'])) {
       ...
       $acertos = 0;
        ...
        // Depuração
        echo "<pre>";
        echo "Resposta 1: $resposta1\n";
        echo "Resposta 2: $resposta2\n";
        echo "Resposta 3: $resposta3\n";
        echo "Resposta 4: $resposta4\n";
        echo "resposta 5: $resposta5\n";
        echo "</pre>";
